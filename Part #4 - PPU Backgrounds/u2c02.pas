...
var
  bg_pixel, bg_palette, p0_pixel, p1_pixel, bg_pal0, bg_pal1: Byte;
  bit_mux: Word;
begin
  ...
  if (cycle > 0) and (cycle <= sprScreen.Size.x) and (scanline >= 0) and (scanline < sprScreen.Size.y) then
    sprScreen.Pixel[cycle - 1, scanline] := GetColourFromPaletteRam(bg_palette, bg_pixel);
  ...
  for nTileY:=0 to 15 do
    ...
    begin
      ...
      begin
        ...
        for col:=0 to 7 do
        begin
          pixel := (tile_lsb and $01) + (tile_msb and $01);
